...
import JavaOOP.ReflectionAndAnnotation.Exercise.barracksWars.interfaces.*;
...
public class CommandInterpreterImpl implements CommandInterpreter {
    ...
    public Executable interpretCommand(String[] data, String commandName) {
        ...
        try {
            Class<?> command = Class.forName(getCorrectClassName("JavaOOP.ReflectionAndAnnotation.Exercise.barracksWars.core.commands.", commandName));
