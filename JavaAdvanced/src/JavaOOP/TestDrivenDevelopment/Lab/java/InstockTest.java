package JavaOOP.TestDrivenDevelopment.Lab.java;
...
public class InstockTest {
    ...
    @Test
    public void testAddProductShouldAddProductInsideTheStock() {
    ...
    @Test
    public void testFindByIndexShouldReturnTheCorrectProduct(){
        stock.add(defaultProduct);
    ...
    @Test
    public void testFindByIndexShouldReturnTheCorrectProductWhenTheProductIsInBetweenTheOtherProducts(){
        stubProducts();
        stock.add(defaultProduct);
    ...
    @Test(expected = IndexOutOfBoundsException.class)
    public void testFindByIndexShouldFailWhenTryToReachNegativeIndex(){
        stubProducts();
        stock.find(-1);
    }

    @Test
    public void testChangeQuantityShouldUpdateTheCorrectProductWithCorrectQuantityAmount(){
        stubProducts();
        stock.add(defaultProduct);
    ...
    @Test (expected = IllegalArgumentException.class)
    public void testFindByLabelShouldTrowIFProductIsNotPresent(){
        stubProducts();
        Product byLabel = stock.findByLabel(defaultProduct.label);
    ...
    public void testFindFirstByAlphabeticalOrderShouldReturnTheObjectsSorted(){
        ...
        expectedLabels.addAll(list.stream().map(Product::getLabel).collect(Collectors.toCollection(TreeSet::new)));
    ...
    @Test
    public void testFindAllInRangeShouldReturnProductsByPriceDescending(){
        stubProducts();
        List<Product> products = createListFromIterable(stock.findAllInRange(10, 30));
    ...
    @Test (expected = IllegalArgumentException.class)
    public void testFindFirstMostExpensiveProductsShoutFailIfTheCountIsGreaterThanTheTotalNumberOfProducts(){
        stubProducts();
